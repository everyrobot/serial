                ...
                gc.desktop.__serverPingHandler = setInterval(function() {
                    ...
                    xmlhttp.onreadystatechange = function () {
                        if (xmlhttp.readyState == 4 && xmlhttp.status == 0) {
                            clearInterval(gc.desktop.__serverPingHandler);
                            alert("Server is not responding, please restart the application. You might want to set these arguments in the launcher.json file to prevent server timeout: --keepAliveMonitorEnabled=false, --keepAliveTimeout=9999");
                        }
                    };
