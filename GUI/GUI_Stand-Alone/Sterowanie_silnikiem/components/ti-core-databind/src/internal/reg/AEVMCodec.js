...
(function() {
    ...
    AEVMCodec.prototype.checkFirmware = function(info) {
        var promises = [];
    ...
    AEVMCodec.prototype.connect = function(settings) {
        ...
        self._ocfIF.system.init().then(function() {
            ...
            return self.checkFirmware({detectedFirmwareVersion: self._ocfIF.system.getSystemInfo().version, modelID: settings.length && settings[0]._registerModel._id, codec: self, controller: 'aevm'})
        }).then(function() {
