...
(function()
{
    ...
    gc.databind.AbstractBindValue.prototype.clearDeferredWrite = function() 
    {
        ...
        {
            this.fCachedValue = this.fCommittedValue;
        }
    };
...
(function()
{
    ...
    gc.databind.AbstractAsyncBindValue.prototype.onValueChanged = function(oldValue, newValue, progress)
    {
        ...
        if (this._writable && !that.fDeferredMode)
        {
     ...
     * @protected
     */
    gc.databind.AbstractAsyncBindValue.prototype.isRefreshable = function()
    {
        // volatile implies readable, so we don't have to test for this._readable as well here.
        return this._state === IDLE && this._hasListeners && this._volatile && !this.isDeferredWritePending();
    };
